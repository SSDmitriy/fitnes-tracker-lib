...
// meanSpeed возвращает значение средней скорости движения (в км/ч) во время тренировки.
//
// Параметры:
//
// action int — количество совершенных действий(число шагов при ходьбе и беге, либо гребков при плавании).
...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	totalCalories = ((runningCaloriesMeanSpeedMultiplier * meanSpeed(action, duration) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	totalCalories = ((walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeedInMsec, 2)/heightInM)*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	totalCalories = (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) *
